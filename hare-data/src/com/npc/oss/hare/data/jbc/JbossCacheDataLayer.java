 ...
 * 
 */
package com.npc.oss.hare.data.jbc;
 ...
 *
 */
public class JbossCacheDataLayer implements EnterpriseDataLayer {
	private final static Log LOG = LogFactory.getLog(JbossCacheDataLayer.class);
